...
class TradingAutomationService {
  ...
  async validateConfig() {
    ...
    this.workers.set('orchestrationCleanup', orchestrationCleanupWorker);
    ...
    this.logger.info('  Orchestration Workers: Orchestration, Language, AI, Message, TradeOffer, RemoveFriend, FollowUp, OrchestrationCleanup');
    this.logger.info('  (InventoryWorker runs in automate_trading_workers service)');
  }
  ...
  async startWorkers() {
    ...
    const startOrder = [
      ...
      'language',            // Start fifth - language detection
      'ai',                  // Start sixth - AI processing
      'message',             // Start seventh - message sending
      'tradeOffer',          // Start eighth - trade offer management
      'removeFriend',        // Start ninth - friend removal
      'followUp',            // Start tenth - follow-up processing
      'adminNotification',   // Start eleventh - admin notification processing
      'orchestrationCleanup' // Start last - cleanup orphaned orchestration tasks
    ];
  ...
  setupShutdownHandlers() {
    const shutdown = async (signal) => {
      ...
      try {
        ...
        const stopOrder = [
          'orchestrationCleanup', 'adminNotification', 'followUp', 'removeFriend', 'tradeOffer', 'message',
  ...
  pauseOrchestrationSystem() {
    const orchestrationWorkers = [
      // 'inventory' runs in automate_trading_workers service
      'orchestration', 'language', 'ai',
      'message', 'tradeOffer', 'removeFriend', 'followUp', 'adminNotification'
    ];
